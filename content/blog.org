...
To investigate a link REMnux offers so many awesome tools. I will cover [[https://github.com/buffer/thug][THUG]], which is a "honeyclient". A honeyclient is a tool that mimick the behavior of a web browser. Useful to see what a link does when a user clicks on it.
**** Running THUG
#+begin_src sh
